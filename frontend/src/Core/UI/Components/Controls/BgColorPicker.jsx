...
function BgColorPicker({ onChange }) {
  ...
  return (
    <div className="w-full p-4 mb-2 bg-cyan-700 rounded text-white">
      <h3 className="text-xl font-semibold mb-3">Background Color</h3>
              ...
              {shades.map((shade) => {
                ...
                return (
                  <button
                    ...
                    className={`hover:ring-2 hover:ring-gray-300 w-7 h-7 outline dark:outline-black outline-white ${colorClass} ${
