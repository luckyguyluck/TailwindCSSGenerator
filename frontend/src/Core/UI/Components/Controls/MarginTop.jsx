...
function MarginTop({onChange}) {
  const parts = TailwindBasicClasses.margin.top;
  ...
  return (
    <div className="w-full bg-cyan-200 dark:bg-cyan-800 rounded-2xl p-4 pt-0 mb-4">
      <h2 className="text-2xl font-semibold">MarginTop</h2>
      ...
      <div className="w-full p-2 mb-4">
        <div className="mb-4">
          <input
            type="checkbox"
            id="MarginTopPresetCheckBox"
            checked={currentInput === "preset"}
            onChange={() => setCurrentInput(currentInput === "preset" ? "slider" : "preset")}
            className="w-4 h-4 me-4"
          />
          <label htmlFor="MarginTopPresetCheckBox" className="text-xl cursor-pointer">Use Preset</label>
        </div>
      ...
      <div className="w-full p-2 mb-4">
        <div className="mb-4">
          <input
            type="checkbox"
            id="MarginTopSliderCheckBox"
            checked={currentInput === "slider"}
            onChange={() => setCurrentInput(currentInput === "slider" ? "preset" : "slider")}
            className="w-4 h-4 me-4"
          />
          <label htmlFor="MarginTopSliderCheckBox" className="text-xl cursor-pointer">Use Slider</label>
        </div>
